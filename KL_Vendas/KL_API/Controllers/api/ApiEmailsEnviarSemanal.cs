...
{
    public class RequestSemanal
    {
        public string id_cliente { get; set; }
    }

    [ApiExplorerSettings(IgnoreApi = true)]
    public class ApiEmailsEnviarSemanalController : ApiController
    {
        [HttpPost]
        public HttpResponseMessage Post([FromBody] RequestSemanal obj)
        {
            Models.Integracao.Integracao integracao = new Models.Integracao.Integracao();

            var emails_enviar = integracao.RetornaEmailsEnviarAPISemanal(obj.id_cliente);
