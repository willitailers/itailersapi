...
namespace KL_UOL
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Integração Karspersky");
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //
                        c.DocumentTitle("Italiers Ativação Karspersky v1");
        ...
        private static string ResolveBasePath(HttpRequestMessage message)
        {
            ...
            var schemeAndHost = "http://" + message.RequestUri.Host;
            return new Uri(new Uri(schemeAndHost, UriKind.Absolute), virtualPathRoot).AbsoluteUri;
        }

        private static string GetXmlCommentsPath()
        {
            return System.AppDomain.CurrentDomain.BaseDirectory + @"bin\KL_UOL.xml";
        }
    }
}
