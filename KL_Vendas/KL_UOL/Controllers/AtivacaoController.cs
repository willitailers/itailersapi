...
{
    public class AtivacaoController : ApiController
    {
        // POST: api/Ativacao
        /// <summary>
        /// Ativação de licença de Anti-Virus Karspersky
        /// </summary>
        /// <param name="ativacao">Objeto de ativação de Anti-Virus Karspersky</param>
        /// <response code="200">Sucesso na ativação</response>
        /// <response code="406">Informações incorretas</response>
        /// <response code="400">Bad Request</response>
        public HttpResponseMessage Post([FromBody]Ativacao_Envio ativacao)
        {
            try
            {
                var retorno = new Ativacao_Controle().ativar(ativacao);
