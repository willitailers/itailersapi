...
namespace KL_Vendas
{
    public partial class KTS : System.Web.UI.Page
    {
        ...
        {
            Avaliacao aval = new Avaliacao() { tp_acao = 1, id_avaliacao = 0, nm_avaliacao = "", nm_titulo = "", nm_pagina = "KTS", id_melhor_produto = 0, nm_melhor_produto = "", nm_titulo_melhor_produto = "" };
        ...
        {
            int id_tipo_produto = int.Parse(System.Configuration.ConfigurationManager.AppSettings["KTS"].ToString());
