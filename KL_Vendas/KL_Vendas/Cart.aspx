<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="KL_Vendas.Cart" %>
...
<!-- End Google Tag Manager -->
    ...
    <title>Kaspersky Antivirus | Proteção Linktel</title>
...
<!-- End Google Tag Manager (noscript) -->
    <form id="form1" runat="server">
        <asp:Label runat="server" Visible="false" ID="lblCdProduto"></asp:Label>
       <asp:Label runat="server" Visible="false" ID="lblToken"></asp:Label>
       <asp:Label runat="server" Visible="false" ID="lblIdProduto"></asp:Label>
       <asp:Label runat="server" Visible="false" ID="lblIdProdutoSub"></asp:Label>
        <asp:Label runat="server" Visible="false" ID="lblCartdID"></asp:Label>
       <div id="root">
            ...
            <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-4">
                <div class="MuiGrid-root MuiBox-root jss148 MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6">
                    <div class="MuiGrid-root MuiGrid-container">
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                            <form>
                                <div class="MuiGrid-root signup-form_fieldWrapper__14GLw MuiGrid-container MuiGrid-spacing-xs-1">
                                    <asp:Panel runat="server" ID="pnlDados" CssClass="MuiGrid-grid-xs-12">
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <h1 class="signup-form_mainTitle__2-QYj">Passo 1 de 2</h1>
                                            <div class="signup-form_mainSubTitle__3L4Xq">Preencha seus dados</div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                    <asp:TextBox runat="server" ID="txtNome" CssClass="MuiInputBase-input MuiInput-input" placeholder="Nome"></asp:TextBox>
                                                </div>
                                                <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidatorNome" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtNome" ValidationGroup="Dados"></asp:RequiredFieldValidator></p>
                                            </div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                    <asp:TextBox runat="server" ID="txtEmail" CssClass="MuiInputBase-input MuiInput-input" placeholder="Email"></asp:TextBox>
                                                </div>
                                                <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidatorEmail" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtEmail" ValidationGroup="Dados"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="Red" ControlToValidate="txtEmail" ErrorMessage="E-mail incorreto" ValidationGroup="Dados"></asp:RegularExpressionValidator></p>
                                            </div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                    <asp:TextBox runat="server" ID="txtTelefone" CssClass="MuiInputBase-input MuiInput-input" placeholder="Telefone" data-mask="(00) 00000-0000"></asp:TextBox>
                                                </div>
                                                <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidatortxtTelefone" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtTelefone" ValidationGroup="Dados"></asp:RequiredFieldValidator></p>
                                            </div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl MuiGrid-grid-xs-12">
                                                    <asp:Label runat="server" ID="lblSexo" Text="Sexo" CssClass="lblPlace"></asp:Label>
                                                    <div >
                                                    <asp:RadioButton runat="server" ID="chkM" Text="Masculino" CssClass=""  GroupName="sexo" />
                                                    <asp:RadioButton runat="server" ID="chkF" Text="Feminino" CssClass=""  GroupName="sexo" />
                                                    <asp:RadioButton runat="server" ID="chkO" Text="Outro" CssClass=""  GroupName="sexo" />
                                                    </div>
                                        ...
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                    <asp:TextBox runat="server" ID="txtCPF" MaxLength="16" CssClass="MuiInputBase-input MuiInput-input" placeholder="CPF" data-mask="00000000000" inputmode="numeric"></asp:TextBox>
                                                </div>
                                                <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtCPF" ValidationGroup="Dados"></asp:RequiredFieldValidator></p>
                                            </div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                    <asp:TextBox runat="server" ID="txtDataNascimento" CssClass="MuiInputBase-input MuiInput-input" placeholder="Data de Nascimento DD/MM/AAAA" data-mask="00/00/0000" inputmode="numeric" MaxLength="10"></asp:TextBox>
                                                </div>
                                                <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtDataNascimento" ValidationGroup="Dados" ></asp:RequiredFieldValidator></p>
                                            </div>
                                        </div>
                                    </asp:Panel>
                                    <asp:Panel runat="server" ID="pnlPagto" Visible="false" CssClass="MuiGrid-grid-xs-12">
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <h1 class="signup-form_mainTitle__2-QYj">Passo 2 de 2</h1>
                                            <div class="signup-form_mainSubTitle__3L4Xq">Reserve sua licença</div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                    <asp:TextBox runat="server" ID="txtNrCartao" MaxLength="16" CssClass="MuiInputBase-input MuiInput-input" placeholder="Número do cartão" data-mask="0000000000000000"></asp:TextBox>
                                                </div>
                                                <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidatortxtNrCartao" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtNrCartao" ValidationGroup="Cad"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationExpression="^\d+$" ForeColor="Red" ControlToValidate="txtNrCartao" ErrorMessage="Cartão aceita apenas numeros" ValidationGroup="Cad"></asp:RegularExpressionValidator>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                            <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                    <asp:TextBox runat="server" ID="txtNomeCartao" CssClass="MuiInputBase-input MuiInput-input" placeholder="Nome do Titular"></asp:TextBox>
                                                </div>
                                                <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidatortxtNomeCartao" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtNomeCartao" ValidationGroup="Cad"></asp:RequiredFieldValidator></p>
                                            </div>
                                        </div>
                                        <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-1 MuiGrid-item MuiGrid-align-items-xs-center MuiGrid-justify-xs-space-between MuiGrid-grid-xs-12">
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6"><span style="text-align: center;" class="lblPlace">Data de Validade</span></div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-3">
                                                <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                    <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                   
                                                        <asp:DropDownList runat="server" ID="ddlMesCartao" ToolTip="Mês:" CssClass="MuiSelect-root MuiSelect-select MuiSelect-selectMenu MuiInputBase-input MuiInput-input MuiInputBase-inputSelect">
                                                        <asp:ListItem Value="01">01-Janeiro</asp:ListItem>
                                                        <asp:ListItem Value="02">02-Fevereiro</asp:ListItem>
                                                        <asp:ListItem Value="03">03-Março</asp:ListItem>
                                                        <asp:ListItem Value="04">04-Abril</asp:ListItem>
                                                        <asp:ListItem Value="05">05-Maio</asp:ListItem>
                                                        <asp:ListItem Value="06">06-Junho</asp:ListItem>
                                                        <asp:ListItem Value="07">07-Julho</asp:ListItem>
                                                        <asp:ListItem Value="08">08-Agosto</asp:ListItem>
                                                        <asp:ListItem Value="09">09-Setembro</asp:ListItem>
                                                    ...
                                                    </asp:DropDownList> <asp:Label runat="server" ID="lbl" Text="/" CssClass="hidden-xs"></asp:Label>
                                            ...
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-3">
                                                <div class="MuiFormControl-root MuiFormControl-fullWidth">
                                                    <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                        ...
                                                        <asp:DropDownList runat="server" ID="ddlAnoCartao" ToolTip="Ano:" CssClass="MuiSelect-root MuiSelect-select MuiSelect-selectMenu MuiInputBase-input MuiInput-input MuiInputBase-inputSelect" >
                                        ...
                                        <div class="MuiGrid-root MuiGrid-container MuiGrid-item MuiGrid-align-items-xs-center MuiGrid-grid-xs-12">
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto">
                                                <div class="MuiFormControl-root" style="width: 80px;">
                                                    <div class="MuiInputBase-root MuiInput-root MuiInput-underline MuiInputBase-formControl MuiInput-formControl">
                                                        <asp:TextBox runat="server" ID="txtCVV" MaxLength="4" CssClass="MuiInputBase-input MuiInput-input" placeholder="CVV" data-mask="0000"></asp:TextBox>
                                                    </div>
                                                    <p class="MuiFormHelperText-root"><asp:RequiredFieldValidator ID="RequiredFieldValidatortxtCVV" runat="server" ErrorMessage="Favor Preencher" ForeColor="Red" ControlToValidate="txtCVV" ValidationGroup="Cad"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="^\d+$" ForeColor="Red" ControlToValidate="txtCVV" ErrorMessage="CVV aceita apenas numeros" ValidationGroup="Cad"></asp:RegularExpressionValidator>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"><img src="/static/media/card.svg" alt="Verso do cartão" style="height: 17px; width: auto; padding-top: 5px; margin-right: 5px; margin-left: 5px;"><span class="signup-form_helperText__3Pg9r">São os 3 números de segurança</span></div>
                                        </div>
                                    </asp:Panel>
                                </div>
                            </form>
                        ...
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                            <asp:Label runat="server" ID="lblErro" Visible="false" ForeColor="Red" Text=""></asp:Label>
                        </div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                            <div class="signup-form_titleWrapper__2Ra4t">
                                <div class="signup-form_title__1tP0D"><asp:Label runat="server" ID="lblNmProduto"></asp:Label></div>
                                <div class="signup-form_subTitle__zuy8e" runat="server" id="aval_gratuita1"><b><asp:Label runat="server" ID="lblNrTrial1"></asp:Label> dias</b> de Avaliação Gratuita</div>
                                <div class="signup-form_price__30mEB">R$ <asp:Label runat="server" ID="lblValorProduto"></asp:Label>/mês</div>
                                
                            </div>
                            <asp:Button runat="server" ID="btnContinuar" CssClass="MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedSecondary MuiButton-fullWidth" Text="Continuar"  ValidationGroup="Dados" OnClick="btnContinuar_Click1" />
                            <asp:Button runat="server" ID="btnEnviar" CssClass="MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedSecondary MuiButton-fullWidth" Text="Assinar"  ValidationGroup="Cad" OnClick="btnContinuar_Click" UseSubmitBehavior="false" OnClientClick="this.disabled = true; this.value = 'Realizando seu pedido';" Visible="false" />
                            <div class="signup-form_titleWrapper__2Ra4t"><div class="signup-form_price__30mEB"><br /><asp:Button runat="server" ID="btnVoltar" CssClass="MuiButtonBase-root MuiButton-root MuiButton-contained" Text="Alterar Dados Pessoais"  OnClick="btnVoltar_Click" Visible="false" /></div></div>
                        </div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                            <p class="signup-form_detailParagraph__2uBJM" runat="server" id="divAvisoTrial">A cobrança será realizada apenas após o término da avaliação gratuita.</p>
                            <p class="signup-form_detailParagraph__2uBJM" runat="server" id="divEmailWifi">O acesso ao Wi-fi LinkTel será enviado no e-mail informado.</p>
                            <p class="signup-form_detailParagraph__2uBJM">Ao assinar confirmo que li e concordo com os<span> Termos de venda</span> e a<span> Política de Privacidade. </span></p>
                            <div class="MuiGrid-root safe-purchase_bar__1pPRP MuiGrid-container MuiGrid-align-items-xs-center MuiGrid-justify-xs-center">
                                <div class="MuiGrid-root MuiGrid-item"><img src="/static/media/padlock.svg" alt="cadeado" />COMPRA SEGURA</div>
                            </div>
                        </div>
                ...
                <div class="MuiGrid-root MuiBox-root jss249 MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-6">
                    <div class="MuiGrid-root detail-purchase_wrapper__1VQ8c MuiGrid-container">
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12" style="padding-left: 5px;">
                            <h1 class="detail-purchase_title__12VHQ"><asp:Label runat="server" ID="lblHeader"></asp:Label></h1></div>
                        <div class="MuiGrid-root MuiGrid-container MuiGrid-item MuiGrid-justify-xs-space-around MuiGrid-grid-xs-12">
                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"> <asp:Image runat="server" ID="imgProduto" CssClass="detail-purchase_productImage__1sYze" /> </div>
                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-8">
                                <h2 class="detail-purchase_title_green__2CqA1" runat="server" id="aval_gratuita2"><asp:Label runat="server" ID="lblValorGratuito"></asp:Label></h2>
                                <div class="detail-purchase_subTitle_green__pxCwb" runat="server" id="valor_depois"><asp:Label runat="server" ID="lblValor"></asp:Label></div>
                                <div class="detail-purchase_productName__1U4ev"><asp:Label runat="server" ID="lblNomeProdutoDetalhe"></asp:Label></div>
                                <div class="detail-purchase_plan__1sgK0"><asp:Label runat="server" ID="lblProdutoSubDescCurta"></asp:Label></div>
                                <div class="detail-purchase_plan__1sgK0"><asp:Label runat="server" ID="lblNmProdutoSub"></asp:Label></div>
                            </div>
                        </div>
                    </div>
                    <div class="MuiGrid-root detail-purchase_flags__2vxvP MuiGrid-container MuiGrid-align-items-xs-center MuiGrid-justify-xs-center">
                        <div class="MuiGrid-root MuiGrid-item"><img src="" alt=""></div>
                    </div>
                    <div class="MuiGrid-root detail-purchase_flags__2vxvP MuiGrid-container MuiGrid-align-items-xs-center MuiGrid-justify-xs-space-between">
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"><img src="/static/media/America.svg" alt="" style="height: 16px;"/></div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"><img src="/static/media/Diners.svg" alt="" style="height: 16px;"/></div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"><img src="/static/media/elo.svg" alt="" style="height: 16px;"/></div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"><img src="/static/media/Hiper.svg" alt="" style="height: 16px;"/></div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"><img src="/static/media/master.svg" alt="" style="height: 16px;"/></div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-auto"><img src="/static/media/Visa.svg" alt="" style="height: 16px;"/></div>
                    </div>
                    <div class="MuiGrid-root detail-purchase_safeBuy__3ey3i MuiGrid-container MuiGrid-align-items-xs-center MuiGrid-justify-xs-center">
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">Compra Segura</div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12"><img src="/static/media/padlock-grey.svg" alt="Cofre de porquinho" style="height: 16px;"/></div>
                    </div>
                </div>
            ...
            <div class="MuiContainer-root MuiContainer-maxWidthLg">
                <div class="MuiGrid-root footer_container__2KFqW MuiGrid-container">
                    <div class="MuiGrid-root MuiGrid-container MuiGrid-item MuiGrid-align-items-xs-center MuiGrid-grid-xs-12 MuiGrid-grid-md-6">
                        <div class="MuiGrid-root footer_mail__3DY-C MuiGrid-container MuiGrid-item MuiGrid-align-items-xs-center MuiGrid-grid-xs-12">
                            <img src="/static/media/Email.svg" alt="Icone de carta"/>falecom@antiviruslinktel.com.br</div>
                        <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
        ...
        <script>
            function makeDate(){
                obj = document.getElementById("<%=txtDataNascimento.ClientID%>");
                vl = obj.value;
