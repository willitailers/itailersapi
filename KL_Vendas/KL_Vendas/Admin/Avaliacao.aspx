<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="Avaliacao.aspx.cs" Inherits="KL_Vendas.Admin.Avalicacao" %>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-12"> 
                                ...
                                <div class="form-group col-md-5">
									<label>Texto:</label>
									<asp:TextBox runat="server" ID="txtAvaliacao" CssClass="form-control" MaxLength="2000" TextMode="MultiLine" Rows="3"></asp:TextBox>
								</div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <asp:GridView ID="grdAvaliacao" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" Font-Size="Small" OnRowCommand="grdAvaliacao_RowCommand">
                                    <Columns>
                                        <asp:BoundField DataField="id_avalicao" HeaderText="#" />
                                        <asp:BoundField DataField="nm_pagina" HeaderText="Pagina" />
                                        <asp:BoundField DataField="nm_titulo" HeaderText="Titulo" />
                                        <asp:BoundField DataField="nm_avaliacao" HeaderText="Texto" />
