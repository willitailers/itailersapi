<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="TodasLicencas.aspx.cs" Inherits="KL_Vendas.TodasLicencas" %>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Todas Licenças</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Todas Licenças</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						<div class="col-md-12"> 
                               ...
                               <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
									<label>Produto:</label>
									<asp:DropDownList ID="ddlProduto" runat="server" DataValueField="id_produto" DataTextField="nm_produto" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlProduto_SelectedIndexChanged"></asp:DropDownList>
								</div>

                                <div class="form-group col-md-4">
									<label>Sub Produto:</label>
									<asp:DropDownList ID="ddlSubProduto" runat="server" DataValueField="id_produto_sub" DataTextField="nm_produto_sub" CssClass="form-control"></asp:DropDownList>
								</div>
                                <div class="form-group col-md-4">
									<label>Status:</label>
									<asp:DropDownList ID="ddlStatus" runat="server"  CssClass="form-control">
                                        <asp:ListItem Value="0" Text="Ativo"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Recusado"></asp:ListItem>
									</asp:DropDownList>
								</div>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Lista Licenças</div>
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <asp:GridView ID="grdPagamentos" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" Font-Size="12px" OnRowCommand="grdPagamentos_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="cd_ativacao" HeaderText="Cod. Licença" />
                                            <asp:TemplateField HeaderText="Cancelar" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnRecusa" runat="server" CommandName="Recusa" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CssClass="btn btn-danger" Text="Canc. Assinatura" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="E-mail" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnEmail" runat="server" CommandName="Reenviar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CssClass="btn btn-success" Text="Reenvia E-mail" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
