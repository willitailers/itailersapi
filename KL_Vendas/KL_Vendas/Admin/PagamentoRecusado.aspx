<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="PagamentoRecusado.aspx.cs" Inherits="KL_Vendas.PagamentoRecusado" %>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Pagamento Recusado</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Pagamento Recusado</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Lista Pagamentos Recusados</div>
                            <div class="panel-body">
                                <div class="col-md-12">
                                        <asp:GridView ID="grdPagamentos" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" Font-Size="12px">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="nm_motivo_estorno" HeaderText="Motivo" />
                                            </Columns>
                                        </asp:GridView>
                                </div>
                            </div>
